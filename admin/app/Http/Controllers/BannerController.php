...
class BannerController extends Controller
{
    ...
    {
        $banners = Banners::with('images')->latest()->get();
        return Inertia::render('banner/index', ['banners' => $banners]);
    }
    ...
    public function create(){
        ...
        return Inertia::render('banner/web/banner-creare-new', ['listCategroy' => $listCategroy,]);
    }
    ...
    public function edit(Banners $banner)
    {
        ...
        $listCategroy = ListCategroy::all();
        return inertia('banner/web/banner-edit', ['banner' => $list, 'listCategroy' => $listCategroy]);
    }
